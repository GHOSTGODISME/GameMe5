...
{{-- <div class="sub_cont">
    ...
    <a href="#" data-toggle="modal" data-target="#addAnnouncementModal">
        <img class="info_icon" src="{{ asset('img/info_icon.png') }}" alt="info_favicon">
    </a>
...
<!-- Add this modal code at the end of your body or within your existing modal container -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" style="text-align: center;">
                <p>The class code for this class is:</p>
                <p style="font-size: 24px;"><strong>{{ $classroom->joincode }}</strong></p>
            </div>
