                ...
                <div class="accordion" role="tablist" id="accordion-1">
                    <div class="accordion-item">
                        ...
                        <div class="accordion-collapse collapse show item-1" role="tabpanel">
                            <div class="accordion-body">
                                ...
                                <input id="survey_title" class="input-fields" type="text" title="Survey Title" />
                                <span id="title_char_counter" class="char_count">0/0</span>
                                <b>Description</b>
                                <label for="survey_description"></label>
                                <textarea id="survey_description" class="input-fields" title="Survey Description"></textarea>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" role="tab"><button class="accordion-button collapsed"
                                ...
                                aria-expanded="false" aria-controls="accordion-1 .item-3">Accordion Item</button></h2>
