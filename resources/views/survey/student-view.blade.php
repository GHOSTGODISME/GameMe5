...
// }
        ...
        //             left: 10,
        //             right: 10
        //         }; // Adjust margins as needed (in millimeters)

        //         const contentWidth = pdf.internal.pageSize.width - (margins.left + margins.right);
        ...
        //             let pageHeight = contentHeight - currentPosition;
        //             if (pageHeight > (pdf.internal.pageSize.height - (margins.top + margins.bottom))) {
        //                 pageHeight = pdf.internal.pageSize.height - (margins.top + margins.bottom);
        //             }

        //             pdf.addImage(imageData, 'JPEG', margins.left, margins.top - currentPosition, contentWidth,
        //                 contentHeight);

        //             currentPosition += pdf.internal.pageSize.height - (margins.top + margins.bottom);
        //             addedPages++;
        ...
        //         // Open a new window for print preview with the generated PDF
