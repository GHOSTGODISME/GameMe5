...
@section('content')
    ...
    <div class = "title_bar">
        <div>
            <a href="{{ route('create-survey') }}" class="btn btn-dark add-btn"><i class="fa-solid fa-plus"></i> Add Survey</a>
        </div>
                ...
                <tbody>
                    @foreach ($surveys as $survey)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('edit-survey', ['id' => $survey->id]) }}"
                                    class="btn btn-info edit-delete-btn"><i class="fa fa-edit"></i></a>
                                <a class="btn btn-danger edit-delete-btn" onclick="confirmDelete({{ $survey->id }})"><i
